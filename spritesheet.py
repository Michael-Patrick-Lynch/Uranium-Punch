# the following code was taken from 'Python Crash Course 2nd edition"
# this is a dependency for the project
...
class SpriteSheet:
    ...
    def load_grid_images(self, num_rows, num_cols, x_margin=0, x_padding=0,
        ...
        grid_images = self.images_at(sprite_rects, -1) # I changed this from the original code becuase I wanted to get rid of the black box around the sprites
